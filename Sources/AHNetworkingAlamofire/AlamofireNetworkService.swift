...
private extension AHNetworking.ParameterEncoding {

    func alamofireEncoding(withOptions options: AHNetworking.ParameterEncoding.Options) -> Alamofire.ParameterEncoding {
        switch self {
...
private extension AHNetworking.ParameterEncoding.Options.BoolEncoding {
